...
function c5037726.rfilter(c)
	return c:IsAttribute(ATTRIBUTE_LIGHT)
end
function c5037726.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	e:SetLabel(1)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroupCost(tp,c5037726.rfilter,1,false,aux.ReleaseCheckMMZ,nil) end
	local g=Duel.SelectReleaseGroupCost(tp,c5037726.rfilter,1,1,false,aux.ReleaseCheckMMZ,nil)
