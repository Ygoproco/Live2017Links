...
function s.exfilter(c,e)
	return c:IsType(TYPE_LINK) and c:IsCanBeFusionMaterial() and c:IsAbleToGrave() and (not e or not c:IsImmuneToEffect(e))
end
...
function s.fcheck(tp,sg,fc)
	local ct=sg:FilterCount(aux.NOT(Card.IsControler),nil,tp)
