...
function c37781520.hdcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c37781520.costfilter,1,false,nil,e:GetHandler()) end
	local sg=Duel.SelectReleaseGroupCost(tp,c37781520.costfilter,1,1,false,nil,e:GetHandler())
