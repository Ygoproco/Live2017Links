...
function c26845680.cfilter(c,ft)
...
function c26845680.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c26845680.cfilter,tp,LOCATION_HAND+LOCATION_MZONE,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
	local g=Duel.SelectMatchingCard(tp,c26845680.cfilter,tp,LOCATION_HAND+LOCATION_MZONE,0,1,1,nil)
