...
function c6075801.initial_effect(c)
	...
	c:RegisterEffect(e1)
	aux.AddEREquipLimit(c,nil,c6075801.eqval,c6075801.equipop,e1)
	local e2=e1:Clone()
	e2:SetCode(EVENT_SPSUMMON_SUCCESS)
	c:RegisterEffect(e2)
	aux.AddEREquipLimit(c,nil,c6075801.eqval,c6075801.equipop,e2)
	--immune
...
function c6075801.eqval(ec,c,tp)
...
function c6075801.equipop(c,e,tp,tc)
