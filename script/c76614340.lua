...
function c76614340.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcMix(c,false,false,91731841,aux.FilterBoolFunction(Card.IsFusionSetCard,0x1047))
	--spsummon condition
...
function c76614340.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c76614340.costfilter,1,false,nil,e:GetHandler()) end
	local rg=Duel.SelectReleaseGroupCost(tp,c76614340.costfilter,1,1,false,nil,e:GetHandler())
