...
function c35448319.cfilter(c)
	return c:IsRace(RACE_PLANT)
end
function c35448319.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	local dg=Duel.GetMatchingGroup(c35448319.filter,tp,0,LOCATION_ONFIELD,nil,e)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c35448319.cfilter,1,false,aux.ReleaseCheckTarget,nil,dg) end
	local sg=Duel.SelectReleaseGroupCost(tp,c35448319.cfilter,1,1,false,aux.ReleaseCheckTarget,nil,dg)
	Duel.Release(sg,REASON_COST)
end
function c35448319.filter(c,e)
