...
function c57728570.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c57728570.costfilter,1,false,nil,nil) end
	local g=Duel.SelectReleaseGroupCost(tp,c57728570.costfilter,1,1,false,nil,nil)
...
function c57728570.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if ct>0 and #g>0 and Duel.SelectYesNo(1-tp,aux.Stringid(57728570,0)) then
		Duel.BreakEffect()
