...
function c78792195.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c78792195.cfilter,1,false,aux.ReleaseCheckTarget,nil,dg) end
	local sg=Duel.SelectReleaseGroupCost(tp,c78792195.cfilter,1,1,false,aux.ReleaseCheckTarget,nil,dg)
