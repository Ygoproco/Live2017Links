...
function c71340250.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroupCost(tp,c71340250.costfilter,1,false,nil,nil,tp,ft) end
	local sg=Duel.SelectReleaseGroupCost(tp,c71340250.costfilter,1,1,false,nil,nil,tp,ft)
...
function c71340250.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then
		...
		return aux.bfgcost(e,tp,eg,ep,ev,re,r,rp,0) and Duel.GetLocationCountFromEx(tp)>0
