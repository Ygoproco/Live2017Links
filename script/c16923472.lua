...
function c16923472.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c16923472.costfilter,1,false,nil,nil) end
	local sg=Duel.SelectReleaseGroupCost(tp,c16923472.costfilter,1,1,false,nil,nil)
