...
function c55838342.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and 
		Duel.IsPlayerCanSpecialSummonMonster(tp,55838342,0x01040116,0x21,300,2100,2,RACE_INSECT,ATTRIBUTE_EARTH) end
...
function c55838342.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(tp,LOCATION_MZONE)<=0
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,55838342,0x01040116,0x21,300,2100,2,RACE_INSECT,ATTRIBUTE_EARTH) then return end
