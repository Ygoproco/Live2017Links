...
function c13361027.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroupCost(tp,c13361027.cfilter,1,false,aux.ReleaseCheckMMZ,nil) end
	local rg=Duel.SelectReleaseGroupCost(tp,c13361027.cfilter,1,1,false,aux.ReleaseCheckMMZ,nil)
