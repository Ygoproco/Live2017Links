...
function c34834619.initial_effect(c)
	aux.AddRitualProcEqualCode(c,nil,4,85346853)
	--spsummon
...
function c34834619.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		local mg=Duel.GetMatchingGroup(c34834619.mtfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,e:GetHandler(),e)
...
function c34834619.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local mg=Duel.GetMatchingGroup(c34834619.mtfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,nil,e)
