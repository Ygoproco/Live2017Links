...
function c100410026.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	if c100410026.lkcon(e,tp,eg,ep,ev,re,r,rp)
		and c100410026.lkcost(e,tp,eg,ep,ev,re,r,rp,0)
		and c100410026.lktg(e,tp,eg,ep,ev,re,r,rp,0)
		and Duel.SelectYesNo(tp,94) then
		e:SetCategory(CATEGORY_SPECIAL_SUMMON)
		e:SetOperation(c100410026.lkop)
		c100410026.lkcost(e,tp,eg,ep,ev,re,r,rp,1)
		c100410026.lktg(e,tp,eg,ep,ev,re,r,rp,1)
	else
		e:SetCategory(0)
		e:SetOperation(nil)
	end
