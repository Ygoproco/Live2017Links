...
function c101006048.initial_effect(c)
	...
	e1:SetCountLimit(1,101006048)
	e1:SetCondition(c101006048.condition)
	e1:SetTarget(c101006048.target)
	e1:SetOperation(c101006048.operation)
	c:RegisterEffect(e1)
end
function c101006048.condition(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsSummonType(SUMMON_TYPE_LINK)
end
function c101006048.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c101006048.operation(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(Card.IsRace,tp,LOCATION_GRAVE,LOCATION_GRAVE,nil,RACE_DRAGON+RACE_DINOSAUR+RACE_SEASERPENT+RACE_WYRM)
