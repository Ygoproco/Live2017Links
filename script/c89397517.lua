...
function c89397517.cfilter(c,ft,tp)
...
function c89397517.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckLPCost(tp,2000) and Duel.CheckReleaseGroupCost(tp,c89397517.cfilter,1,false,nil,nil,ft,tp) end
	Duel.PayLPCost(tp,2000)
	local sg=Duel.SelectReleaseGroupCost(tp,c89397517.cfilter,1,1,false,nil,nil,ft,tp)
...
function c89397517.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		e:SetLabel(0)
		return Duel.IsExistingMatchingCard(c89397517.rmfilter,tp,LOCATION_HAND+LOCATION_GRAVE,0,1,nil)
