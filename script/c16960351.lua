...
function c16960351.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroupCost(tp,c16960351.rfilter,1,false,nil,nil,e,tp,ft) end
	local g=Duel.SelectReleaseGroupCost(tp,c16960351.rfilter,1,1,false,nil,nil,e,tp,ft)
	local tc=g:GetFirst()
