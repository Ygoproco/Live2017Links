...
function s.initial_effect(c)
	--Activate
	local e1=aux.CreateRitualProc(c,RITPROC_EQUAL,aux.FilterBoolFunction(Card.IsSetCard,0x3a),nil,nil,s.extrafil,s.extraop,aux.FilterBoolFunction(Card.IsOnField))
	e1:SetCost(s.cost)
	c:RegisterEffect(e1)
end
