...
function c19636995.cfilter(c,tp,seq)
...
function c19636995.hspcon(e,c)
	...
	local zone=0
	for i=0,4 do
		if Duel.GetMatchingGroupCount(c19636995.cfilter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,nil,tp,i)==0 then
...
function c19636995.plchk(e,tp,eg,ep,ev,re,r,rp)
	...
	cg:KeepAlive()
	if c:GetFlagEffect(19636995+1)==0 then
		c:RegisterFlagEffect(19636995+1,RESET_EVENT+0x1fd0000,0,1)
		e:SetLabelObject(cg)
