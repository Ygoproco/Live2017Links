...
function s.filter2(c,e,tp,mc,code,pg)
	return mc:IsType(TYPE_XYZ,c,SUMMON_TYPE_XYZ,tp) and c:IsType(TYPE_XYZ) and c:IsSetCard(0x8d) and not c:IsCode(code) and Duel.GetLocationCountFromEx(tp,tp,mc,c)>0
