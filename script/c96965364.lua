...
function c96965364.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then
		...
		e:SetLabel(0)
		return ft>-1 and Duel.CheckReleaseGroupCost(tp,c96965364.cfilter,1,false,nil,nil,e,tp,ft)
	end
	local rg=Duel.SelectReleaseGroupCost(tp,c96965364.cfilter,1,1,false,nil,nil,e,tp,ft)
