...
function c99877698.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c99877698.costfilter,1,false,nil,nil) end
	local sg=Duel.SelectReleaseGroupCost(tp,c99877698.costfilter,1,1,false,nil,nil)
