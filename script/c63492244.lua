...
function c63492244.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and tc:IsFacedown() and tc:IsRelateToEffect(e) then
		...
		c:RegisterFlagEffect(63492244,RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_END,0,1,fid)
		tc:RegisterFlagEffect(63492244,RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_END,0,1,fid)
		local e1=Effect.CreateEffect(c)
		e1:SetType(EFFECT_TYPE_SINGLE)
...
function c63492244.rstop2(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:GetFlagEffectLabel(63492244)~=e:GetLabel() or tc==e:GetOwner() then return end
	local c=e:GetOwner()
