...
function c48447192.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(48447192,0))
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetCode(EVENT_BATTLE_DESTROYING)
	e1:SetRange(LOCATION_SZONE)
	e1:SetCondition(c48447192.descon)
	e1:SetTarget(c48447192.destg)
	e1:SetOperation(c48447192.desop)
	c:RegisterEffect(e1)
	--todeck
	local e2=Effect.CreateEffect(c)
	e2:SetCategory(CATEGORY_TODECK)
	e2:SetDescription(aux.Stringid(48447192,1))
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_GRAVE)
	e2:SetCost(c48447192.retcost)
	e2:SetTarget(c48447192.rettg)
	e2:SetOperation(c48447192.retop)
	c:RegisterEffect(e2)
end
