...
function c100227025.initial_effect(c)
	...
	e6:SetCondition(c100227025.damcon)
	e6:SetTarget(c100227025.damtg)
	e6:SetOperation(c100227025.damop)
	c:RegisterEffect(e6)
	--to deck
...
function c100227025.damtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetTargetPlayer(1-tp)
	Duel.SetTargetParam(2000)
	Duel.SetOperationInfo(0,CATEGORY_DAMAGE,nil,0,1-tp,2000)
end
function c100227025.damop(e,tp,eg,ep,ev,re,r,rp)
	local p,d=Duel.GetChainInfo(0,CHAININFO_TARGET_PLAYER,CHAININFO_TARGET_PARAM)
	Duel.Damage(p,d,REASON_EFFECT)
end
function c100227025.tdcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==tp
end
function c100227025.tdtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
