...
function c66607691.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,Card.IsCode,2,false,aux.ReleaseCheckMMZ,nil,70095154) end
	local g=Duel.SelectReleaseGroupCost(tp,Card.IsCode,2,2,false,aux.ReleaseCheckMMZ,nil,70095154)
