...
function c21830679.initial_effect(c)
	...
	e1:SetTarget(c21830679.tktg)
	e1:SetOperation(c21830679.tkop)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	e2:SetCode(EVENT_SPSUMMON_SUCCESS)
	c:RegisterEffect(e2)
end
function c21830679.tktg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c21830679.tkop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
