...
function Auxiliary.LinkCondition(f,minc,maxc,specialchk)
	return	function(e,c)
				...
				local sg=mustg
				return (mg+tg):Includes(mustg) and ((#sg>=minc and aux.LCheckGoal(tp,mustg,c,minc,f,specialchk,{})) or (mg+tg):IsExists(Auxiliary.LCheckRecursive,1,sg,tp,sg,(mg+tg),c,minc,maxc,f,specialchk,mg,emt))
			end
end
