...
function c54913680.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c54913680.costfilter,2,false,aux.ReleaseCheckMMZ,nil) end
	local g=Duel.SelectReleaseGroupCost(tp,c54913680.costfilter,2,2,false,aux.ReleaseCheckMMZ,nil)
