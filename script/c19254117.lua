...
function c19254117.tgtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(aux.FilterEqualFunction(Card.GetFlagEffect,0,19254117),tp,LOCATION_MZONE,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TARGET)
	Duel.SelectTarget(tp,aux.FilterEqualFunction(Card.GetFlagEffect,0,19254117),tp,LOCATION_MZONE,0,1,1,nil)
end
