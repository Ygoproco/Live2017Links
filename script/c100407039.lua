...
function c100407039.thfilter(c,tp)
	return c:IsSetCard(0x1034) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
		and Duel.IsExistingMatchingCard(c100407039.plfilter,tp,LOCATION_DECK,0,1,nil,c:GetCode())
end
function c100407039.plfilter(c,code)
