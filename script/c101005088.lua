...
function c101005088.initial_effect(c)
	...
	e1:SetCondition(c101005088.spcon)
	c:RegisterEffect(e1)
	--gain
	...
	e2:SetCondition(c101005088.mtcon)
	e2:SetOperation(c101005088.mtop)
	c:RegisterEffect(e2)
end
function c101005088.filter(c)
	return c:IsFaceup() and c:IsType(TYPE_EQUIP) and c:IsSetCard(0x207a)
end
function c101005088.spcon(e,c)
...
function c101005088.mtop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetOperation(c101005088.effop)
	...
	rc:RegisterFlagEffect(0,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,EFFECT_FLAG_CLIENT_HINT,1,0,aux.Stringid(101005088,0))
end
function c101005088.effop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetFlagEffect(tp,101005088)~=0 then return end
	local c=e:GetHandler()
	...
	e0:SetTarget(c101005088.splimit)
...
function c101005088.splimit(e,c,sump,sumtype,sumpos,targetp,se)
