...
function c46247282.disop(e,tp)
	...
	if seq==1 and (Duel.CheckLocation(tp,LOCATION_MZONE,5) and Duel.CheckLocation(1-tp,LOCATION_MZONE,6)) then flag=flag+(2^5) end
	if seq==3 and (Duel.CheckLocation(tp,LOCATION_MZONE,6) and Duel.CheckLocation(1-tp,LOCATION_MZONE,5)) then flag=flag+(2^6) end
	return flag
end
