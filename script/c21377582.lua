...
function c21377582.initial_effect(c)
	...
	--immune
    	...
    	e4:SetCondition(c21377582.regcon)
    	e4:SetOperation(c21377582.regop)
	...
	e5:SetCondition(c21377582.descon)
	e5:SetCost(c21377582.descost)
	e5:SetTarget(c21377582.destg)
	e5:SetOperation(c21377582.desop)
	c:RegisterEffect(e5)
end
