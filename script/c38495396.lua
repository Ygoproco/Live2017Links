...
function s.ovfilter(c,tp,xyzc)
	return c:IsFaceup() and c:IsSetCard(0x53) and c:GetCode()~=id and c:IsType(TYPE_XYZ,xyzc,SUMMON_TYPE_XYZ,tp)
end
...
function s.thtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.SelectTarget(tp,s.thfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,LOCATION_MZONE+LOCATION_GRAVE,1,1,nil)
