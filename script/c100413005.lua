...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if s.negcon(e,tp,eg,ep,ev,re,r,rp)
		and s.negcost(e,tp,eg,ep,ev,re,r,rp,0)
		and s.negtg(e,tp,eg,ep,ev,re,r,rp,0)
		and Duel.SelectEffectYesNo(tp,e:GetHandler()) then
		s.negcost(e,tp,eg,ep,ev,re,r,rp,1)
		s.negtg(e,tp,eg,ep,ev,re,r,rp,1)
...
function s.negop(e,tp,eg,ep,ev,re,r,rp)
	...
	local sg=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(s.spfilter),tp,LOCATION_HAND+LOCATION_GRAVE,0,1,1,nil,e,tp,e:GetLabel())
