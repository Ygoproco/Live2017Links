...
function c30968774.initial_effect(c)
	...
	e1:SetCondition(c30968774.condition)
	e1:SetTarget(c30968774.target)
	e1:SetOperation(c30968774.operation)
	c:RegisterEffect(e1)
end
function c30968774.condition(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsLocation(LOCATION_GRAVE) and r & REASON_LINK == REASON_LINK
end
function c30968774.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c30968774.operation(e,tp,eg,ep,ev,re,r,rp)
