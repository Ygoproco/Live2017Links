...
function c44509529.spcheck(sg,e,tp)
...
function c44509529.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return ft>1 and not Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT)
		and aux.SelectUnselectGroup(g,e,tp,2,2,c44509529.spcheck,0) end
	local tg=aux.SelectUnselectGroup(g,e,tp,2,2,c44509529.spcheck,1,tp,HINTMSG_SPSUMMON)
