...
function c29013526.cfilter(c,ft,tp)
...
function c29013526.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c29013526.cfilter,1,false,nil,e:GetHandler(),ft,tp) end
	local g=Duel.SelectReleaseGroupCost(tp,c29013526.cfilter,1,1,false,nil,e:GetHandler(),ft,tp)
