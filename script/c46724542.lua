...
function c46724542.initial_effect(c)
	--link summon
	c:EnableReviveLimit()
	aux.AddLinkProcedure(c,aux.FilterBoolFunctionEx(Card.IsRace,RACE_MACHINE),2,2,c46724542.lcheck)
	--code
...
function c46724542.lcheck(g,lc)
	return g:IsExists(Card.IsLinkCode,1,nil,CARD_CYBER_DRAGON)
end
