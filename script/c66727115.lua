...
function c66727115.rfilter(c,e,tp,ft)
...
function c66727115.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then
		...
		e:SetLabel(0)
		return ft>-1 and Duel.CheckReleaseGroupCost(tp,c66727115.rfilter,1,false,nil,nil,e,tp,ft)
	end
	local g=Duel.SelectReleaseGroupCost(tp,c66727115.rfilter,1,1,false,nil,nil,e,tp,ft)
