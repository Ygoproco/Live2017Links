...
function c83347294.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroupCost(tp,c83347294.rfilter,1,false,nil,nil,ft,tp) end
	local sg=Duel.SelectReleaseGroupCost(tp,c83347294.rfilter,1,1,false,nil,nil,ft,tp)
