...
function c101006014.initial_effect(c)
	...
	e1:SetCondition(c101006014.spcon1)
	...
	e2:SetCondition(c101006014.spcon2)
	c:RegisterEffect(e2)
end
function c101006014.spcon1(e,tp,eg,ep,ev,re,r,rp)
	return not Duel.IsPlayerAffectedByEffect(tp,CARD_ORPHEGEL_BABEL)
end
function c101006014.spcon2(e,tp,eg,ep,ev,re,r,rp)
