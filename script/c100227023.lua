...
function c100227023.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(100227023,0))
	e2:SetProperty(EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE)
	e2:SetType(EFFECT_TYPE_SINGLE)
	e2:SetCode(EFFECT_SUMMON_PROC)
	e2:SetRange(LOCATION_HAND)
	e2:SetCondition(c100227023.spcon)
	c:RegisterEffect(e2)
	--indes
	...
	e6:SetCondition(c100227023.damcon)
	e6:SetTarget(c100227023.damtg)
	e6:SetOperation(c100227023.damop)
	c:RegisterEffect(e6)
	--to deck
	local e7=Effect.CreateEffect(c)
	e7:SetDescription(aux.Stringid(100227023,1))
	...
	e7:SetTarget(c100227023.tdtg)
	e7:SetOperation(c100227023.tdop)
	c:RegisterEffect(e7)
end
function c100227023.spcon(e,c)
...
function c100227023.tdcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==tp
end
function c100227023.tdtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
