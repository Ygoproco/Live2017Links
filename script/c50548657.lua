...
function c50548657.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroupCost(tp,c50548657.costfilter,1,false,nil,nil,e,tp,g,ft) end
	local sg=Duel.SelectReleaseGroupCost(tp,c50548657.costfilter,1,1,false,nil,nil,e,tp,g,ft)
