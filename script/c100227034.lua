...
function c100227034.initial_effect(c)
	--Activate
	...
	e1:SetCountLimit(1,100227034)
	e1:SetCondition(c100227034.condition)
	e1:SetTarget(c100227034.target)
...
function c100227034.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return g:GetCount()==2 and g:FilterCount(c100227034.cfilter,nil)==2
end
...
function c100227034.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetTarget(c100227034.limittg)
	e1:SetReset(RESET_PHASE+PHASE_END)
	e1:SetLabel(spc)
	Duel.RegisterEffect(e1,tp)
	local e2=e1:Clone()
	e2:SetCode(EFFECT_LEFT_SPSUMMON_COUNT)
	e2:SetValue(c100227034.countval)
	Duel.RegisterEffect(e2,tp)
end
function c100227034.limittg(e,c,tp)
	local sp=Duel.GetActivityCount(tp,ACTIVITY_SPSUMMON)
	return sp-e:GetLabel()>=1
end
function c100227034.countval(e,re,tp)
	local sp=Duel.GetActivityCount(tp,ACTIVITY_SPSUMMON)
