...
function c63120904.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local b2=Duel.CheckReleaseGroupCost(tp,Card.IsCode,1,false,nil,nil,95614612) and Duel.IsExistingTarget(c63120904.dfilter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,1,nil)
	if chk==0 then return b1 or b2 end
	local code=0
	if b1 and b2 then
		local rg=Duel.SelectReleaseGroupCost(tp,c63120904.rfilter,1,1,false,nil,nil)
