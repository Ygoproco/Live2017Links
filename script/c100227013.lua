...
function c100227013.initial_effect(c)
	...
	e1:SetValue(c100227013.efilter)
	c:RegisterEffect(e1)
	...
	e3:SetCondition(c100227013.atkcon)
	e3:SetValue(3000)
	c:RegisterEffect(e3)
	local e4=e3:Clone()
	...
	e5:SetDescription(aux.Stringid(100227013,0))
	e5:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e5:SetProperty(EFFECT_FLAG_DELAY+EFFECT_FLAG_DAMAGE_STEP)
	e5:SetCode(EVENT_DESTROYED)
	e5:SetCondition(c100227013.setcon)
	e5:SetTarget(c100227013.settg)
	e5:SetOperation(c100227013.setop)
	c:RegisterEffect(e5)
end
function c100227013.efilter(e,te)
	return te:IsActiveType(TYPE_TRAP)
end
function c100227013.filter(c)
	return c:IsFaceup() and c:IsType(TYPE_TRAP)
end
function c100227013.atkcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c100227013.filter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,1,nil)
end
function c100227013.setcon(e,tp,eg,ep,ev,re,r,rp)
...
function c100227013.setfilter(c)
