...
function c101006068.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(101006068,0))
	e4:SetType(EFFECT_TYPE_QUICK_O)
	e4:SetRange(LOCATION_SZONE)
	e4:SetCode(EVENT_FREE_CHAIN)
	e4:SetCountLimit(1)
	e4:SetCondition(c101006068.accon)
	e4:SetOperation(c101006068.acop)
	c:RegisterEffect(e4)
	--set
	local e5=Effect.CreateEffect(c)
	e5:SetDescription(aux.Stringid(101006068,1))
	e5:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e5:SetCode(EVENT_TO_GRAVE)
	e5:SetProperty(EFFECT_FLAG_DELAY)
	e5:SetCondition(c101006068.setcon)
	e5:SetTarget(c101006068.settg)
	e5:SetOperation(c101006068.setop)
	c:RegisterEffect(e5)
end
