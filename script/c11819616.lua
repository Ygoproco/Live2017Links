...
function c11819616.discost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c11819616.costfilter,1,false,nil,nil) end
	local sg=Duel.SelectReleaseGroupCost(tp,c11819616.costfilter,1,1,false,nil,nil)
