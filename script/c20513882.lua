...
function c20513882.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		e:SetLabel(0)
		return Duel.CheckReleaseGroupCost(tp,c20513882.cfilter,1,false,nil,nil,tp)
	end
	local g=Duel.SelectReleaseGroupCost(tp,c20513882.cfilter,1,1,false,nil,nil,tp)
