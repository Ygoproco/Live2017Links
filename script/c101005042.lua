...
function c101005042.initial_effect(c)
	...
	e2:SetTarget(c101005042.atklimit)
	c:RegisterEffect(e2)
	--Search
...
function c101005042.atklimit(e,c)
	return e:GetHandler():GetLinkedGroup():IsContains(c)
end
function c101005042.thcfilter(c,tp,lg)
...
function c101005042.thcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return eg:IsExists(c101005042.thcfilter,1,nil,tp,lg)
end
function c101005042.thfilter(c,tp)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x217) and c:IsAbleToHand()
end
function c101005042.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c101005042.thfilter,tp,LOCATION_DECK,0,1,nil,tp) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c101005042.thop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g1=Duel.SelectMatchingCard(tp,c101005042.thfilter,tp,LOCATION_DECK,0,1,1,nil,tp)
