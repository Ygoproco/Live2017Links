...
function c29649320.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	if c29649320.thcon(e,tp,eg,ep,ev,re,r,rp) and c29649320.thcost(e,tp,eg,ep,ev,re,r,rp,0) 
		and c29649320.thtg(e,tp,eg,ep,ev,re,r,rp,0) and Duel.SelectYesNo(tp,aux.Stringid(29649320,0)) then
		e:SetCategory(CATEGORY_TOHAND+CATEGORY_SEARCH)
		e:SetOperation(c29649320.thop)
		c29649320.thcost(e,tp,eg,ep,ev,re,r,rp,1)
		c29649320.thtg(e,tp,eg,ep,ev,re,r,rp,1)
	else
		e:SetCategory(0)
		e:SetOperation(nil)
	end
...
function c29649320.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c29649320.thfilter,tp,LOCATION_DECK+LOCATION_GRAVE,0,1,nil)
		and e:GetHandler():GetFlagEffect(29649320)==0 end
	e:GetHandler():RegisterFlagEffect(29649320,RESET_PHASE+PHASE_END,0,1)
