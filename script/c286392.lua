...
function c286392.initial_effect(c)
	--synchro summon
	aux.AddSynchroProcedure(c,c286392.tfilter,1,1,aux.NonTuner(nil),1,99)
	c:EnableReviveLimit()
	--tohand
...
function c286392.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroupCost(tp,c286392.cfilter,1,false,nil,nil,ft,tp) end
	local g=Duel.SelectReleaseGroupCost(tp,c286392.cfilter,1,1,false,nil,nil,ft,tp)
