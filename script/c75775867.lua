...
function c75775867.descost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c75775867.cfilter,1,false,aux.ReleaseCheckTarget,nil,dg) end
	local g=Duel.SelectReleaseGroupCost(tp,c75775867.cfilter,1,1,false,aux.ReleaseCheckTarget,nil,dg)
