...
function c71797713.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local flag=0
	if g:IsExists(c71797713.regfilter,1,nil,ATTRIBUTE_EARTH+ATTRIBUTE_WIND) then flag=flag|0x1 end
	if g:IsExists(c71797713.regfilter,1,nil,ATTRIBUTE_WATER+ATTRIBUTE_FIRE) then flag=flag|0x2 end
	if g:IsExists(c71797713.regfilter,1,nil,ATTRIBUTE_LIGHT+ATTRIBUTE_DARK) then flag=flag|0x4 end
