...
function c85555787.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return matk>0 and Duel.CheckReleaseGroupCost(tp,c85555787.costfilter,1,false,nil,nil,matk) end
	local g=Duel.SelectReleaseGroupCost(tp,c85555787.costfilter,1,1,false,nil,nil,matk)
