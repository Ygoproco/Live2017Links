...
function s.spcheck(sg,e,tp)
	return aux.ChkfMMZ(1)(sg,e,tp,nil) and sg:GetClassCount(Card.GetAttribute)==#sg
end
...
function s.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.GetMatchingGroup(aux.FilterFaceupFunction(Card.IsAttribute,arc),tp,LOCATION_MZONE,LOCATION_MZONE,nil)
	if #g>0 then
