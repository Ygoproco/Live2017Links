...
function c69846323.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c69846323.cfilter,1,false,nil,e:GetHandler()) end
	local sg=Duel.SelectReleaseGroupCost(tp,c69846323.cfilter,1,1,false,nil,e:GetHandler())
