...
function c74094021.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c74094021.cfilter,1,false,aux.ReleaseCheckTarget,e:GetHandler(),dg) end
	local sg=Duel.SelectReleaseGroupCost(tp,c74094021.cfilter,1,1,false,aux.ReleaseCheckTarget,e:GetHandler(),dg)
