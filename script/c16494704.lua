...
function c16494704.initial_effect(c)
	aux.AddRitualProcGreater(c,c16494704.ritualfil,nil,c16494704.extrafil,c16494704.extraop,c16494704.forcedgroup,LOCATION_HAND+LOCATION_GRAVE):SetCountLimit(1,16494704+EFFECT_COUNT_CODE_OATH)
end
function c16494704.ritualfil(c)
	return c:IsRace(RACE_DRAGON) and (c:GetType()&0x81)==0x81
end
