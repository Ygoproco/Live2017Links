...
function c96782886.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.CheckLPCost(tp,800)
		and ft>-1 and Duel.CheckReleaseGroupCost(tp,c96782886.costfilter,1,false,nil,nil,ft,tp) end
	Duel.PayLPCost(tp,800)
	local sg=Duel.SelectReleaseGroupCost(tp,c96782886.costfilter,1,1,false,nil,nil,ft,tp)
