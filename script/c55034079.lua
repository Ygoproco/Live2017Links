...
function c55034079.initial_effect(c)
	...
	e1:SetOperation(c55034079.operation)
	c:RegisterEffect(e1)
	--counter
...
function c55034079.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return c55034079.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc) end
	local c=e:GetHandler()
	if chk==0 then return Duel.IsCanAddCounter(tp,0x48,4,c) end
	if c55034079.spcon(e,tp,eg,ep,ev,re,r,rp) and c55034079.spcost(e,tp,eg,ep,ev,re,r,rp,0)
		and c55034079.sptg(e,tp,eg,ep,ev,re,r,rp,0) and Duel.SelectYesNo(tp,aux.Stringid(55034079,0)) then
			e:SetCategory(CATEGORY_COUNTER+CATEGORY_SPECIAL_SUMMON)
			e:SetProperty(EFFECT_FLAG_CARD_TARGET)
			e:SetOperation(c55034079.spop)
			c55034079.spcost(e,tp,eg,ep,ev,re,r,rp,1)
			c55034079.sptg(e,tp,eg,ep,ev,re,r,rp,1)
		end
end
function c55034079.operation(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
