...
function c51630558.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c51630558.filter,1,false,nil,nil) end
	local g=Duel.SelectReleaseGroupCost(tp,c51630558.filter,1,1,false,nil,nil)
