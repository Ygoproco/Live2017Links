...
function c29876529.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		if e:GetLabel()~=0 then
			e:SetLabel(0)
			return Duel.CheckReleaseGroupCost(tp,c29876529.costfilter,1,false,nil,nil)
		else
	...
	if e:GetLabel()==1 then
		e:SetLabel(0)
		local rg=Duel.SelectReleaseGroupCost(tp,c29876529.costfilter,1,1,false,nil,nil)
