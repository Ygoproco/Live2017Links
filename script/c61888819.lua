...
function c61888819.initial_effect(c)
    ...
    e1:SetValue(c61888819.fmval)
    c:RegisterEffect(e1)
    --force mzone
    local e2=e1:Clone()
    e2:SetTargetRange(0,1)
    e2:SetValue(c61888819.fmval2)
    c:RegisterEffect(e2)
...
function c61888819.fmval(e,c)
	if aux.ExtraSummon and Duel.GetMasterRule()>=4 then
		if aux.SummoningCard then
		Debug.Message(aux.SummoningCard:GetCode())
		end
