...
function c69313735.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then
		...
		e:SetLabel(0)
		return Duel.CheckReleaseGroupCost(tp,c69313735.rfilter,1,false,nil,nil,tp)
	end
	if e:GetLabel()~=0 then
		e:SetLabel(0)
		local rg=Duel.SelectReleaseGroupCost(tp,c69313735.rfilter,1,1,false,nil,nil,tp)
