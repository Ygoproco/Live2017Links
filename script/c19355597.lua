...
function c19355597.initial_effect(c)
	...
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcMixN(c,false,false,aux.FilterBoolFunction(Card.IsFusionSetCard,0x1047),3)
	--spsummon condition
...
function c19355597.spfilter(c,e,tp,mc)
...
function c19355597.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c19355597.tgfilter,tp,LOCATION_MZONE,0,1,nil,e,tp)
