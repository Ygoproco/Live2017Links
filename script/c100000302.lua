...
function c100000302.initial_effect(c)
	...
	c:RegisterEffect(e1)
	aux.AddEREquipLimit(c,nil,function(ec,_,tp) return ec:IsControler(1-tp) end,c100000302.equipop,e1)
end
...
function c100000302.equipop(c,e,tp,tc)
