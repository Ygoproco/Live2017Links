...
function c13235258.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c13235258.filter,tp,LOCATION_MZONE,0,1,nil) end
...
function c13235258.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and tc:IsRelateToEffect(e) and tc:IsFaceup() then
		...
		e5:SetOperation(c13235258.regop)
		c:RegisterEffect(e5)
...
function c13235258.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(13235258,RESET_EVENT+0x1fc0000+RESET_CHAIN,0,1)
end
function c13235258.ctcon2(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetEquipTarget() and ep~=tp and e:GetHandler():GetFlagEffect(13235258)~=0
end
