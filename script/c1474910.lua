...
function c1474910.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsReleasable() and Duel.CheckReleaseGroupCost(tp,c1474910.cfilter,1,false,nil,nil) end
	local g=Duel.SelectReleaseGroupCost(tp,c1474910.cfilter,1,1,false,nil,nil)
