...
function c101005077.spcheck(sg,tp,exg,dg)
	local a=0
...
function c101005077.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then
		if e:GetLabel()==1 then
			e:SetLabel(0)
			return Duel.CheckReleaseGroupCost(tp,nil,1,false,c101005077.spcheck,nil,dg)
		else
	...
	if e:GetLabel()==1 then
		e:SetLabel(0)
		local sg=Duel.SelectReleaseGroupCost(tp,c101005077.cfilter,1,1,false,c101005077.spcheck,nil,dg)
