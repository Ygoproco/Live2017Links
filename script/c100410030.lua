...
function c100410030.initial_effect(c)
	...
	e1:SetCountLimit(1,100410030)
	e1:SetTarget(c100410030.sptg)
	e1:SetOperation(c100410030.spop)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	...
	e3:SetTarget(c100410030.sumlimit)
	c:RegisterEffect(e3)
end
...
function c100410030.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingTarget(c100410030.spfilter,tp,LOCATION_GRAVE,0,1,nil,e,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectTarget(tp,c100410030.spfilter,tp,LOCATION_GRAVE,0,1,1,nil,e,tp)
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,g,1,0,0)
end
function c100410030.spop(e,tp,eg,ep,ev,re,r,rp)
