...
function c76353872.initial_effect(c)
	...
	e2:SetCountLimit(1)
	e2:SetTarget(c76353872.deftg)
	e2:SetOperation(c76353872.defop)
	c:RegisterEffect(e2)
end
...
function c76353872.deftg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c76353872.defop(e,tp,eg,ep,ev,re,r,rp)
	...
	if not at:IsImmuneToEffect(e1) and not at:IsImmuneToEffect(e2) and at:IsAttackPos()
		and at:IsCanChangePosition() and Duel.SelectYesNo(tp,aux.Stringid(76353872,2)) then
		Duel.BreakEffect()
