...
function c32995276.matfilter(c,lc,sumtype,tp)
...
function c32995276.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c32995276.cfilter,1,false,nil,nil,lg) end
	local g=Duel.SelectReleaseGroupCost(tp,c32995276.cfilter,1,1,false,nil,nil,lg)
