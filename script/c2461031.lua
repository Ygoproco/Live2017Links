...
function c2461031.initial_effect(c)
	...
	c:RegisterEffect(e1)
	aux.AddEREquipLimit(c,nil,c2461031.eqval,c2461031.equipop,e1)
	--equip effect
...
function c2461031.eqval(ec,c,tp)
...
function c2461031.equipop(c,e,tp,tc)
