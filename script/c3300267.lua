...
function c3300267.hspcon(e,c)
	...
	return ft>-1 and Duel.CheckReleaseGroupCost(tp,c3300267.hspfilter,1,false,nil,nil,ft,tp)
end
function c3300267.hspop(e,tp,eg,ep,ev,re,r,rp,c)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	local g=Duel.SelectReleaseGroupCost(tp,c3300267.hspfilter,1,1,false,nil,nil,ft,tp)
