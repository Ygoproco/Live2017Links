...
function c29139104.cfilter(c,ft,tp)
...
function c29139104.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c29139104.cfilter,1,false,nil,e:GetHandler(),ft,tp) end
	local g=Duel.SelectReleaseGroupCost(tp,c29139104.cfilter,1,1,false,nil,e:GetHandler(),ft,tp)
