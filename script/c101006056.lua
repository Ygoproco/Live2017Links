...
function c101006056.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e1:SetTarget(c101006056.sumlimit)
...
function c101006056.sumlimit(e,c,sump,sumtype,sumpos,targetp,se)
...
function c101006056.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) then
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
		local dg=Duel.SelectMatchingCard(tp,c101006056.filter2,tp,LOCATION_DECK,0,1,1,nil,e,tp,tc:GetLevel())
