...
function c75923050.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcMix(c,true,true,92421852,38916461)
	--atk up
...
function c75923050.spfilter(c,e,tp)
	return c:IsCode(1412158) and Duel.GetLocationCountFromEx(tp,tp,e:GetHandler(),c)>0 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
