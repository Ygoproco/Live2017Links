...
function c97688360.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c97688360.atkfilter1,1,false,nil,nil,tp) end
	local g=Duel.SelectReleaseGroupCost(tp,c97688360.atkfilter1,1,1,false,nil,nil,tp)
