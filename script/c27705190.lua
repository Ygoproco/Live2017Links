...
function c27705190.initial_effect(c)
	...
	e1:SetCondition(c27705190.cecon)
	e1:SetTarget(c27705190.cetg)
	e1:SetOperation(c27705190.ceop)
	c:RegisterEffect(e1)
	--special summon
	...
	e2:SetTarget(c27705190.sptg)
	e2:SetOperation(c27705190.spop)
	c:RegisterEffect(e2)
end
...
function c27705190.cecon(e,tp,eg,ep,ev,re,r,rp)
...
function c27705190.spfilter1(c,e,tp)
	...
	return c:IsFaceup() and c:IsType(TYPE_LINK) and Duel.IsExistingMatchingCard(c27705190.spfilter2,tp,0x13,0,1,c,e,tp,zone)
end
...
function c27705190.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c27705190.spop(e,tp,eg,ep,ev,re,r,rp)
