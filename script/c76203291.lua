...
function c76203291.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c76203291.cfilter,1,false,aux.ReleaseCheckTarget,e:GetHandler(),dg) end
	local g=Duel.SelectReleaseGroupCost(tp,c76203291.cfilter,1,1,false,aux.ReleaseCheckTarget,e:GetHandler(),dg)
