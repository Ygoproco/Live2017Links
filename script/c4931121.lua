...
function c4931121.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c4931121.costfilter,1,false,nil,nil) end
	local g=Duel.SelectReleaseGroupCost(tp,c4931121.costfilter,1,1,false,nil,nil)
...
function c4931121.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	e3:SetOperation(c4931121.reset)
	e3:SetReset(RESET_PHASE+PHASE_END+RESET_OPPO_TURN,3)
	c:RegisterEffect(e3)
end
function c4931121.reset(e,tp,eg,ep,ev,re,r,rp)
	c4931121.turnop(e:GetLabelObject(),tp,eg,ep,ev,e,r,rp)
end
