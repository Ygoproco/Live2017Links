...
function c91272072.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcMix(c,true,true,c91272072.matfilter,aux.FilterBoolFunction(Card.IsFusionSetCard,0xfb))
	--avoid damage
...
c91272072.material_setcode={0xfb}
function c91272072.matfilter(c,fc,sumtype,tp)
