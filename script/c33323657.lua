...
function c33323657.reccost(e,tp,eg,ep,ev,re,r,rp,chk)
	e:SetLabel(1)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c33323657.filter,1,false,nil,nil) end
	local g=Duel.SelectReleaseGroupCost(tp,c33323657.filter,1,1,false,nil,nil)
