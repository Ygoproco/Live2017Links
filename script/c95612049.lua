...
function c95612049.filterF(c,tp,mg,rc)
...
function c95612049.target(e,tp,eg,ep,ev,re,r,rp,chk)
    if chk==0 then
        ...
        return ft>0 and Duel.IsExistingMatchingCard(c95612049.filter,tp,LOCATION_HAND+LOCATION_DECK,0,1,nil,e,tp,mg,ft)
    end
...
function c95612049.activate(e,tp,eg,ep,ev,re,r,rp)
    ...
    local tg=Duel.SelectMatchingCard(tp,c95612049.filter,tp,LOCATION_HAND+LOCATION_DECK,0,1,1,nil,e,tp,mg,ft)
