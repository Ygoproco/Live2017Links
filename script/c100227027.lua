...
function c100227027.reptg(e,tp,eg,ep,ev,re,r,rp,chk)
    ...
    if chk==0 then return e:GetHandler():IsReason(REASON_EFFECT) and c:GetReasonPlayer()~=tp and e:GetHandler():GetFlagEffect(100227027+100)==0 end
    c:RegisterFlagEffect(100227027+100,RESET_EVENT+0x1fe0000,0,1)
	return true
end
