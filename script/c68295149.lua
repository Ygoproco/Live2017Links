...
function s.initial_effect(c)
	...
	e2a:SetTarget(aux.TargetBoolFunction(Card.IsSummonLocation,LOCATION_EXTRA))
	...
	e2b:SetTarget(aux.TargetBoolFunction(Card.IsSummonLocation,LOCATION_EXTRA))
	e2b:SetValue(s.tgval)
