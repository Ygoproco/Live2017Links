...
function c63259351.initial_effect(c)
	...
	e2:SetTarget(c63259351.rmlimit)
	c:RegisterEffect(e2)
	--add counter
	...
	e3:SetOperation(c63259351.ctop)
	c:RegisterEffect(e3)
	--special summon
	local e4=Effect.CreateEffect(c)
	e4:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e4:SetDescription(aux.Stringid(63259351,0))
	e4:SetType(EFFECT_TYPE_IGNITION)
	e4:SetRange(LOCATION_MZONE)
	e4:SetCost(c63259351.spcost)
	e4:SetTarget(c63259351.sptg)
	e4:SetOperation(c63259351.spop)
	c:RegisterEffect(e4)
end
function c63259351.rmlimit(e,c,p)
...
function c63259351.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>0 and Duel.IsExistingMatchingCard(c63259351.spfilter,tp,LOCATION_DECK,0,1,nil,e:GetHandler():GetCounter(0x14),e,tp) end
