...
function c85840608.initial_effect(c)
	...
	e1:SetTarget(c85840608.sptg)
	e1:SetOperation(c85840608.spop)
	c:RegisterEffect(e1)
	--sp summon
	...
	e2:SetCost(c85840608.spcost)
	e2:SetTarget(c85840608.sptg2)
	e2:SetOperation(c85840608.spop2)
	c:RegisterEffect(e2)
end
c85840608.listed_names={CARD_NEOS}
...
function c85840608.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c85840608.spop(e,tp,eg,ep,ev,re,r,rp)
...
function c85840608.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
