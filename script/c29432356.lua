...
function c29432356.checkop(e,tp)
	...
	if olpz~=nil and orpz~=nil and olpz:GetFlagEffect(29432356)<=0
		...
		olpz:RegisterFlagEffect(29432356,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	end
end
...
function c29432356.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroupCost(tp,c29432356.spcfilter,1,false,nil,nil,ft,tp) end
	local sg=Duel.SelectReleaseGroupCost(tp,c29432356.spcfilter,1,1,false,nil,nil,ft,tp)
