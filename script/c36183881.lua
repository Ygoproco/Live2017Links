...
function c36183881.filter(c,e)
	return c:IsAbleToRemove() and (not e or c:IsCanBeEffectTarget(e))
end
function c36183881.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	local dg=Duel.GetMatchingGroup(c36183881.filter,tp,0,LOCATION_MZONE,nil,e)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c36183881.cfilter,1,false,aux.ReleaseCheckTarget,nil,dg) end
	local g=Duel.SelectReleaseGroupCost(tp,c36183881.cfilter,1,1,false,aux.ReleaseCheckTarget,nil,dg)
