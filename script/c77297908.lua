...
function c77297908.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c77297908.cfilter3,tp,LOCATION_DECK,0,1,1,e:GetLabel())
...
function c77297908.chop1(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.ChangeChainOperation(ev,c77297908.repop)
end
