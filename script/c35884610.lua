...
function c35884610.initial_effect(c)
	...
	e3:SetCondition(c35884610.damcon)
	e3:SetOperation(c35884610.damop)
	c:RegisterEffect(e3)
	--chain atk
	local e4=Effect.CreateEffect(c)
	e4:SetDescription(aux.Stringid(35884610,0))
	e4:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e4:SetRange(LOCATION_SZONE)
	e4:SetCode(EVENT_BATTLED)
	e4:SetCondition(c35884610.atcon)
	e4:SetOperation(c35884610.atop)
	c:RegisterEffect(e4)
	--remove
	...
	e5:SetCountLimit(1)
	e5:SetCondition(c35884610.rmcon)
	e5:SetTarget(c35884610.rmtg)
	e5:SetOperation(c35884610.rmop)
	c:RegisterEffect(e5)
	--to hand
	local e6=Effect.CreateEffect(c)
	e6:SetDescription(aux.Stringid(35884610,1))
	e6:SetCategory(CATEGORY_TOHAND)
	e6:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e6:SetProperty(EFFECT_FLAG_DELAY)
	e6:SetCode(EVENT_TO_GRAVE)
	e6:SetCondition(c35884610.thcon)
	e6:SetTarget(c35884610.thtg)
	e6:SetOperation(c35884610.thop)
	c:RegisterEffect(e6)
end
