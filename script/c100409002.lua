...
function c100409002.negop(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c100409002.filter(c,e,tp)
...
function c100409002.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAbleToDeck() and Duel.IsExistingMatchingCard(c100409002.filter,tp,LOCATION_DECK,0,1,nil,e,tp) end
...
function c100409002.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and c:IsControler(tp) and Duel.SendtoDeck(e:GetHandler(),nil,2,REASON_EFFECT)~=0 then
		...
		local g=Duel.SelectMatchingCard(tp,c100409002.filter,tp,LOCATION_DECK,0,1,1,nil,e,tp)
