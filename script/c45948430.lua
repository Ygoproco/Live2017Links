...
function s.initial_effect(c)
	local e1=aux.CreateRitualProc(c,RITPROC_GREATER,aux.FilterBoolFunction(Card.IsSetCard,0x10cf),8,nil,s.extragroup,s.extraop,s.matfilter,nil,LOCATION_HAND|LOCATION_GRAVE,s.ritcheck,nil,s.specificfilter)
...
function s.ritcheck(e,tp,g,sc)
	return #g==2 and g:IsExists(Card.IsAttribute,1,nil,ATTRIBUTE_LIGHT) and g:IsExists(Card.IsAttribute,1,nil,ATTRIBUTE_DARK) and g:IsExists(Card.IsLocation,1,nil,LOCATION_HAND) and g:IsExists(Card.IsLocation,1,nil,LOCATION_DECK)
end
