...
function c88696724.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then
		...
		local mg2=Duel.GetMatchingGroup(c88696724.fil,tp,0,LOCATION_MZONE,nil,tp)
		Auxiliary.FCheckAdditional=c88696724.fcheck(mg2)
		local res=Duel.IsExistingMatchingCard(c88696724.filter,tp,LOCATION_EXTRA,0,1,nil,e,tp,mg+mg2,c,chkf)
	...
	local g=Duel.SelectMatchingCard(tp,c88696724.filter,tp,LOCATION_EXTRA,0,1,1,nil,e,tp,mg+mg2,c,chkf)
