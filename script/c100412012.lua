...
function s.filter1(c,e,tp)
	...
	return #pg<=1 and c:IsFaceup() and c:IsSetCard(0x227) and (rk>0 or c:IsStatus(STATUS_NO_LEVEL)) and Duel.GetLocationCountFromEx(tp,tp,c)>0 
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetProperty(EFFECT_FLAG_PLAYER_TARGEEFFECT_FLAG_CLIENT_HINT)
