...
function c10424147.spfilter1(c,e,tp)
	...
	return pg:GetCount()<=1 and c:IsFaceup() and c:IsSetCard(0x10dc)
		and Duel.IsExistingMatchingCard(c10424147.spfilter2,tp,LOCATION_EXTRA,0,1,nil,e,tp,c,c:GetAttribute(),pg)
end
function c10424147.spfilter2(c,e,tp,mc,att,pg)
...
function c10424147.spop1(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c10424147.spfilter2,tp,LOCATION_EXTRA,0,1,1,nil,e,tp,tc,tc:GetAttribute(),pg)
	local sc=g:GetFirst()
	if sc then
