...
function c58873391.spcheck(sg,tp,exg,dg)
	local a=0
...
function c58873391.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then
		...
		if e:GetLabel()==1 then
			e:SetLabel(0)
			return Duel.CheckReleaseGroupCost(tp,c58873391.cfilter,1,false,c58873391.spcheck,nil,dg)
		else
	...
	if e:GetLabel()==1 then
		e:SetLabel(0)
		local sg=Duel.SelectReleaseGroupCost(tp,c58873391.cfilter,1,1,false,c58873391.spcheck,nil,dg)
