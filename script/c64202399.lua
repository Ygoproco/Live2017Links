...
s.listed_names={89631139,24094653}
function s.cfilter(c)
	return c:IsCode(89631139) and (c:IsLocation(LOCATION_GRAVE) or c:IsOnField() and c:IsFaceup())
end
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(s.cfilter,tp,LOCATION_ONFIELD+LOCATION_GRAVE,0,1,nil)
end
function s.thfilter1(c)
	return (c:IsCode(24094653) or c:IsRitualSpell()) and c:IsAbleToHand()
end
