...
function s.initial_effect(c)
	local e1=aux.CreateRitualProc(c,RITPROC_EQUAL,aux.FilterBoolFunction(Card.IsSetCard,0x106),nil,nil,s.extragroup,s.extraop,nil,s.stage2,LOCATION_HAND|LOCATION_GRAVE,s.ritcheck)
