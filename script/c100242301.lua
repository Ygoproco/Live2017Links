...
function c100242301.initial_effect(c)
	...
	e3:SetCondition(c100242301.spcon)
	e3:SetTarget(c100242301.sptg)
	e3:SetOperation(c100242301.spop)
	c:RegisterEffect(e3)
end
c100242301.listed_names={CARD_SUMMONED_SKULL }
function c100242301.spcon(e,tp,eg,ep,ev,re,r,rp)
...
function c100242301.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		return Duel.IsExistingMatchingCard(c100242301.spfilter,tp,LOCATION_HAND+LOCATION_DECK+LOCATION_GRAVE,0,1,nil,e,tp)
	end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,tp,LOCATION_HAND+LOCATION_DECK+LOCATION_GRAVE)
end
function c100242301.spop(e,tp,eg,ep,ev,re,r,rp)
