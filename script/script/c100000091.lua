...
function c100000091.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c100000091.cfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,2,nil) end
	local g=Duel.SelectMatchingCard(tp,c100000091.cfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,2,2,nil)
