...
function c95238394.filter1(c,e)
	return c95238394.filter0(c) and not c:IsImmuneToEffect(e)
end
...
function c95238394.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		local chkf=tp
		local mg=Duel.GetMatchingGroup(c95238394.filter0,tp,LOCATION_REMOVED+LOCATION_GRAVE+LOCATION_MZONE,0,nil)
